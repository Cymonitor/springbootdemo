...
(function ($) {
    ...
    $.jqPagination = function (el, options) {
        ...
        base.init = function () {
            ...
            base.$input.click('focus.jqPagination mouseup.jqPagination', function (event) {
            ...
            base.$input.click('blur.jqPagination keydown.jqPagination', function (event) {
            ...
            base.$el.click('click.jqPagination', 'a', function (event) {
